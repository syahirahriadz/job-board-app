<div class="w-full mb-5">
    <div class="relative mb-4">
        ...
        <input
            type="search"
            wire:model.live="searchApplication"
            placeholder="Search for applicant name, email, or job title…"
    ...
    @if($searchApplication)
        <div class="mt-3 flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            Searching for: "{{ $searchApplication }}"
            <button wire:click="$set('searchApplication', '')" class="ml-2 text-blue-500 hover:text-blue-700 text-xs">
                Clear
            </button>
        </div>
    @endif
